...
I am looking at open, local alternatives that are blazing fast even (especially) on a CPU — a working prototype of that idea lives on the [wasm-offscreen](https://github.com/shubhxms/local-filter/tree/wasm-offscreen) branch. Feel free to reach out to talk about that. :)
